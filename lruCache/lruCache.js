...
var LRUCacheItem = function (val, key) {
  // does this generate a new ListNode? what about previous?
  return ListNode(prev,val, key);
};
...
LRUCache.prototype.set = function (key, val) {
  // when we set a new key-value pair, we want to delete the oldest item
  // oldest on the outside? newest added to the next?
  this.shift();
  this.moveToEnd(this);
